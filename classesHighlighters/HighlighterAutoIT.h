...
#ifndef HEADER_HIGHLIGHTERAUTOIT
#define HEADER_HIGHLIGHTERAUTOIT
...
class HighlighterAutoIT : public QSyntaxHighlighter
{
        Q_OBJECT

        public:
                HighlighterAutoIT(QTextDocument *parent);
        ...
        private:
                ...
                QTextCharFormat formatMotsClesRegExp;
                QTextCharFormat formatMotsClesRegExp2;
                QTextCharFormat formatNombres;
                QTextCharFormat formatVariables;
