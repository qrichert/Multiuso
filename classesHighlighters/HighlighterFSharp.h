...
#ifndef HEADER_HIGHLIGHTERFSHARP
#define HEADER_HIGHLIGHTERFSHARP
...
class HighlighterFSharp : public QSyntaxHighlighter
{
	Q_OBJECT

	public:
		HighlighterFSharp(QTextDocument *parent);
	...
	private:
		...
		QTextCharFormat formatPointFonction;
};
