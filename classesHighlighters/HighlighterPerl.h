...
#ifndef HEADER_HIGHLIGHTERPERL
#define HEADER_HIGHLIGHTERPERL
...
class HighlighterPerl : public QSyntaxHighlighter
{
	Q_OBJECT

	public:
		HighlighterPerl(QTextDocument *parent);
