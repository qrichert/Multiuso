...
#ifndef HEADER_HIGHLIGHTERGLSL
#define HEADER_HIGHLIGHTERGLSL
...
class HighlighterGLSL : public QSyntaxHighlighter
{
        Q_OBJECT

        public:
                HighlighterGLSL(QTextDocument *parent);
        ...
        private:
                ...
                QTextCharFormat formatMotCleGL;
                QTextCharFormat formatPreprocesseur;
