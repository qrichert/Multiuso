...
#ifndef HEADER_HIGHLIGHTERMIRANDA
#define HEADER_HIGHLIGHTERMIRANDA
...
class HighlighterMiranda : public QSyntaxHighlighter
{
        Q_OBJECT

        public:
                HighlighterMiranda(QTextDocument *parent);
