...
#ifndef HEADER_HIGHLIGHTERFORTRAN
#define HEADER_HIGHLIGHTERFORTRAN
...
class HighlighterFortran : public QSyntaxHighlighter
{
        Q_OBJECT

        public:
                HighlighterFortran(QTextDocument *parent);
