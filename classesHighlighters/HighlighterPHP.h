...
#ifndef HEADER_HIGHLIGHTERPHP
#define HEADER_HIGHLIGHTERPHP
...
class HighlighterPHP : public QSyntaxHighlighter
{
        Q_OBJECT

        public:
                HighlighterPHP(QTextDocument *parent);
