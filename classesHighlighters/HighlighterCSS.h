...
#ifndef HEADER_HIGHLIGHTERCSS
#define HEADER_HIGHLIGHTERCSS
...
class HighlighterCSS : public QSyntaxHighlighter
{
        Q_OBJECT

        public:
                HighlighterCSS(QTextDocument *parent);
        ...
        private:
                ...
                QTextCharFormat formatPropriete;
                QTextCharFormat formatCouleurHex;
