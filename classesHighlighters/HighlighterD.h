...
#ifndef HEADER_HIGHLIGHTERD
#define HEADER_HIGHLIGHTERD
...
class HighlighterD : public QSyntaxHighlighter
{
	Q_OBJECT

	public:
		HighlighterD(QTextDocument *parent);
	...
	private:
		...
		QTextCharFormat formatDeQuotationWysiwygOuHex;
		QTextCharFormat formatFonctions;
};
