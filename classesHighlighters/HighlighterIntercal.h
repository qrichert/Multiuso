...
#ifndef HEADER_HIGHLIGHTERINTERCAL
#define HEADER_HIGHLIGHTERINTERCAL
...
class HighlighterIntercal : public QSyntaxHighlighter
{
        Q_OBJECT

        public:
                HighlighterIntercal(QTextDocument *parent);
        ...
        private:
                ...
                QTextCharFormat formatSub;
                QTextCharFormat formatAbstainFrom;
