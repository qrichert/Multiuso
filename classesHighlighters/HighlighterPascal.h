...
#ifndef HEADER_HIGHLIGHTERPASCAL
#define HEADER_HIGHLIGHTERPASCAL
...
class HighlighterPascal : public QSyntaxHighlighter
{
        Q_OBJECT

        public:
                HighlighterPascal(QTextDocument *parent);
        ...
        private:
                ...
                QTextCharFormat formatCommentaireMultiLigne2;
