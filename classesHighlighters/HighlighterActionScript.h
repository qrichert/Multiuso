...
#ifndef HEADER_HIGHLIGHTERACTIONSCRIPT
#define HEADER_HIGHLIGHTERACTIONSCRIPT
...
class HighlighterActionScript : public QSyntaxHighlighter
{
        Q_OBJECT

        public:
                HighlighterActionScript(QTextDocument *parent);
