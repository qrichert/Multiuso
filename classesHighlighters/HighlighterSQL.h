...
#ifndef HEADER_HIGHLIGHTERSQL
#define HEADER_HIGHLIGHTERSQL
...
class HighlighterSQL : public QSyntaxHighlighter
{
	Q_OBJECT

	public:
		HighlighterSQL(QTextDocument *parent);
