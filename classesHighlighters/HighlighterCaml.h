...
#ifndef HEADER_HIGHLIGHTERCAML
#define HEADER_HIGHLIGHTERCAML
...
class HighlighterCaml : public QSyntaxHighlighter
{
	Q_OBJECT

	public:
		HighlighterCaml(QTextDocument *parent);
	...
	private:
		...
		QTextCharFormat formatListe;
		QTextCharFormat formatVector;
};
